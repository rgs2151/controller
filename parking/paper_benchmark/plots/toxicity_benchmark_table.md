...
Toxicity, Dist-2, and PPL are mean ± SE across five complete 1,000-prompt RTP repetitions. MMLU is accuracy ± prompt-level SE on one shared 1,000-question 5-shot set. TBD cells have not been run.
