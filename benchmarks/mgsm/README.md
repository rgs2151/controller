...
Qwen3-4B is complete. The first Llama-3.2-3B-Instruct run exposed a calibration
transfer failure and is superseded by the fixed-target calibration specified
above; its replacement uses Original, S-PID, A-LQR, and H-infinity.
