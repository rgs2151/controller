"""Long-context generation and independent scoring for L-CiteEval Small."""
...
DEFAULT_BATCH_SIZE = {
    "llama32_1b_instruct": {"8k": 10, "16k": 8, "32k": 5},
}
    ...
    *,
    ...
    _write_json(
        destination,
        {
            ...
            "repetitions": [
                {"repetition": 0, "sample_count": EVALUATION_QUESTIONS, "rows": rows}
            ],
        },
    )
    return destination
...
def summarize(
    ...
    *,
    ...
    summary = {
        ...
        "condition": condition,
        "method": method,
        "sample_count": EVALUATION_QUESTIONS,
