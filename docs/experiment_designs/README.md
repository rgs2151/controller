...
|---|---|---|---|---|---|
| [Truthfulness](truthfulness.md) | Truthful, non-misleading answers | TruthfulQA true vs false answers | 200 disjoint TruthfulQA prompts | 200 disjoint TruthfulQA prompts | English and Spanish TruthfulQA; optional MMLU |
...
| [L-CiteEval Small](lciteeval_small.md) | Positive sentiment and enjoyable experiences | 72 positive vs 72 matched negative AXBench examples | 200 frozen AlpacaEval prompts | 10 HotpotQA questions at 8K | The same 10 HotpotQA questions at 8K and 32K by default; optional 16K |
